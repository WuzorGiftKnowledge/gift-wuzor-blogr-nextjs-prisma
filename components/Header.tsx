      ...
      <nav className="container mx-auto px-4 py-3 max-w-7xl">
        <div className="flex items-center justify-between gap-2 md:gap-4">
          ...
          <div className="flex items-center space-x-1 md:space-x-2 flex-shrink-0 min-w-0">
            <Link href="/">
              <a className="flex items-center space-x-1 md:space-x-2 hover:opacity-80 transition-opacity min-w-0">
                <Logo size="sm" />
          ...
          <div className="md:hidden flex items-center space-x-2">
            {session && (
              <Link href="/create">
                <a className="p-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors">
          ...
          <div className="md:hidden mt-4 pt-4 border-t border-gray-200 pb-4">
            <div className="space-y-2">
              ...
              <div className="space-y-1 pl-3 border-l-2 border-indigo-200">
                ...
                <Link href="/testimony">
                  <a onClick={() => setMobileMenuOpen(false)} className="flex items-center px-3 py-2 rounded-lg text-sm text-gray-700 hover:bg-gray-100">
